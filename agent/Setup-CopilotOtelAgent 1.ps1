...
$InsightsUrl        = 'https://34.14.177.44:5080/api/default/insights/_json'
$ChronicleBaseUrl   = 'https://34.14.177.44:5080'
$ChronicleOrg       = 'default'
$PricingApiUrl      = 'https://34.14.177.44:8080/v1/copilot-pricing'
