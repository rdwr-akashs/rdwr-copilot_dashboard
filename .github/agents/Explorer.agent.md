...
target: vscode
tools: [vscode/memory, read/readFile, read/viewImage, read/skill, search/codebase, search/fileSearch, search/listDirectory, search/textSearch, search/usages, web/fetch]
agents: []
---
